  ...
  ajax: {
    runAction(method, data) {
      ...
      switch (method) {
              ...
              data: {
                properties: [
                  ...
                  },
                  {
                    ...
                    type: 'radio',
                    id: 'id_button_fill',
                    name: 'SELECT_BUTTON_FILL',
                    label: 'Заливка кнопок:',
                    options: [
                      {
                        label: 'Сплошная',
                        code: '1',
                  ...
                  {
                    property: 'text',
                    id: 'id_custom_font_name',
                    name: 'TEXT_CUSTOM_FONT_NAME',
                    label: 'Название шрифта для CSS (font-family):',
                    value: '',
                    disabled: false,
                    hint_external:
                      'Введите подсказку для этого блока, которая может быть очень длинная, но мы не будем ее выводить всегда, иногда подсказки не будет совсем.',
                  },
                  {
                    property: 'text',
                    id: 'id_font_width',
                    name: 'TEXT_FONT_WIDTH',
                    label: 'Толщина шрифта',
                    value: '',
                    regexp: 'ddd',
                    regexp_description: 'Значение поля должно быть числом',
                    hint_internal: 'Введите число',
                    hint_external: 'Например 100 или 200.',
                  },
                  {
                    property: 'text',
                    id: 'id_font_size',
        ...
        case 'twinpx:seller.api.methods.colors':
          result = new Promise((resolve) => {
            resolve({
              status: 'success',
              data: {
                ...
                variants: [
                  {
                    id: '1111',
                    name: 'Светлая тема',
                    description: 'Светлая тема сайта',
                    preview: 'upload/block.png',
                    settings: {
                      properties: [
                        {
                          property: 'heading',
                          id: 'heading-color-primary',
                          label:
                            '\u0426\u0432\u0435\u0442 \u043e\u0434\u0438\u043d',
                        },
                        {
                          property: 'color',
                          name: 'settings_color-primary',
                          id: 'settings_color-primary',
                          label:
                            '\u0426\u0432\u0435\u0442 \u043e\u0434\u0438\u043d',
                          required: true,
                          cssvar: true,
                        ...
                        {
                          property: 'heading',
                          id: 'heading-color-secondary',
                          label: '\u0426\u0432\u0435\u0442 \u0434\u0432\u0430',
                        },
                        {
                          property: 'color',
                          name: 'settings_color-secondary',
                          id: 'settings_color-secondary',
                          label: '\u0426\u0432\u0435\u0442 \u0434\u0432\u0430',
                          required: true,
                          cssvar: true,
                          value: '#00aaff',
                        ...
                        {
                          property: 'heading',
                          id: 'heading-color-tertiary',
                          label: '\u0426\u0432\u0435\u0442 \u0442\u0440\u0438',
                        },
                        {
                          property: 'color',
                          name: 'settings_color-tertiary',
                          id: 'settings_color-tertiary',
                          label: '\u0426\u0432\u0435\u0442 \u0442\u0440\u0438',
                          required: true,
                          cssvar: true,
                          value: '#3333cc',
