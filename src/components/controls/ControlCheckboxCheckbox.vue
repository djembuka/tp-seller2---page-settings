...
.twpx-form-controls__checkbox [type='checkbox'] + span {
  position: relative;
  padding-left: 40px;
  cursor: pointer;
  display: inline-flex;
...
.twpx-form-controls__checkbox [type='checkbox'] + span:before {
  content: '';
  position: absolute;
  top: 0;
  left: 0;
...
.twpx-form-controls__checkbox [type='checkbox']:checked + span:before {
  top: -4px;
  left: -5px;
  width: 12px;
  height: 22px;
...
.twpx-form-controls__checkbox [type='checkbox']:checked:disabled + span:before {
  border-right: 2px solid rgba(0, 0, 0, 0.42);
  border-bottom: 2px solid rgba(0, 0, 0, 0.42);
}

.twpx-form-controls__checkbox [type='checkbox'].filled-in + span:before {
  z-index: 11;
}
.twpx-form-controls__checkbox [type='checkbox'].filled-in + span:after {
  border-radius: 8px;
  height: 24px;
  width: 24px;
  z-index: 10;
...
.twpx-form-controls__checkbox [type='checkbox'].filled-in:checked + span:after {
